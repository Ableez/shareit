/**
 * Better Auth tables for the local Convex component install.
 *
 * This is generated by the Better Auth CLI:
 *   npx @better-auth/cli generate --config ./src/server/convex/betterAuth/auth.ts \
 *     --output ./src/server/convex/betterAuth/schema.ts
 *
 * If you change the plugins in `auth.ts`, regenerate this file.
 */
